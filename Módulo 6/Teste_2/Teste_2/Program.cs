...
namespace Teste_2
{
    ...
    public class Sapato
    {
       public string cod, nome, estacao;
       public int preco, ano, tamanho;
    ...
    class Program
    {
        ...
        static void Menu()
        {
            ...
            switch (switch_on)
            {
                case 1:
                    ...
                    break;
                case 2:
                    MostrarSapatosEstacao(lista);
                    break;
                case 3:
                    MostrarSapatosN36(lista);
                    break;
                case 4:
                    MostrarSapatospreco(lista);
                    break;
                case 5:
                    MostrarSapatosm10(lista);
                    break;
                case 6:
                    InserirSapato(lista);
                    break;
                case 7:
                    MostrarDescricaoCod(lista);
                    break;
                case 8:
                    RemoverDescricaoCod(lista);
                    break;
                case 9:
                    Descontos(lista);
                    break;
        ...
        public static void RemoverDescricaoCod(List<Sapato> list)
        {
            ...
            var found = list.Find(x => x.cod == cod);
